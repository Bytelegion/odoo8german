...
class AccountInvoiceLine(models.Model):
    ...
    def perform_datev_validation(self, silent=False, line_no=None):
        ...
        if not (silent or is_valid):
            raise exceptions.DatevWarning(_(u'Line {line}: The taxes specified in the invoice line ({tax_line}) and the corresponding '
                                            u'account ({tax_account}) mismatch!').format(line=line_no,
